...
def main():
    ...
    e2e_path = os.path.join(project_dir, "Selenium_E2E_Test_Report.xlsx")
    sec_path = os.path.join(project_dir, "Vulnerability_Security_Report.xlsx")
    ...
    markdown_output.append(f"| **Login Credentials** | {e2e_summary.get('Login Credentials')} |")
